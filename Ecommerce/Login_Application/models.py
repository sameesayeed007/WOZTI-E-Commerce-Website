...
#User model and profile model has a one to one relation
...
class MyUserManager(BaseUserManager):
    ...
    def _create_user(self, email, password, **extra_fields):
        ...
        return user
    #Additional fiels for the superuser
...
class Profile(models.Model):
    ...
    def is_fully_filled(self):
        fields_names = [f.name for f in self._meta.get_fields()] #all the fields are in fields_names
...
#When the receiver receives a signal that User is created profile is also created
